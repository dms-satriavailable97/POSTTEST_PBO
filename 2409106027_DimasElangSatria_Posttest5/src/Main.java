    ...
    public static void main() {
        ...
        do {
            ...
            if (menuUtama == 1) {
                ...
                if (kode.equals("DISKONSAHUR")) {      //kode diskon bervariasi
                    layananBaru = new BuildCharacter(namaInput, 30000, "Diskon Sahur");
                ...
                System.out.print("Masukkan Catatan Tambahan (Misal: Fokus Crit Rate / Target 3 Hari): ");
                String catatanUser = inputKeyboard.nextLine();
                layananBaru.setCatatan(catatanUser);

                ((ManajemenPesanan) layananBaru).konfirmasiPesanan();
                if (tipe == 1) { ((ManajemenPesanan) layananBaru).estimasiWaktu("3 Hari");}
                else if (tipe == 2) {((ManajemenPesanan) layananBaru).estimasiWaktu(" 1 Minggu");}
                else {((ManajemenPesanan) layananBaru).estimasiWaktu("5 Hari");}


                daftarPesanan.add(new DataJoki(user, pass, hp, layananBaru));
                ...
                for (DataJoki d : daftarPesanan) {
                    ...
                    if (d.getStatus() == 1) {
                        ...
                        System.out.println("   [Akun: " + d.getUsername() + " | WA: " + d.getNomorHp() + "]");
                        nomorAntrian++;
                    }
                }
